 ...
 */
public class LazyDoubleCheckSingletonTest implements Runnable {
     ...
     * 使用set检查生成的单例唯一
     */
    static volatile HashSet<LazyDoubleCheckSingleton> hungrySingletons = new HashSet<>();


    private static LazyDoubleCheckSingleton testedClass;
    ...
    public void testGetInstance() throws Exception {
        ...
        for (int i = 0; i < threadCount; i++) {
            exec.submit(new LazyDoubleCheckSingletonTest());
        }
